...
- xsel (если планируете использовать только просмотрщик, используется в скрипте l_marcus.sh ,для его запуска, копируется md файл в буфер обмена и запускаем скрипт 
 l_marcus.sh, он запустит md файл в просмотрщике md )
